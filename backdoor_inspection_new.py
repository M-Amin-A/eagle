...
def parse_option():
    ...
    parser.add_argument('--model', type=str, default='google_net',
                        choices=['resnet50', 'resnet18', 'preact',
                                 'vgg16',
                                 'google_net',
                                 'simple_cnn',
    ...
    parser.add_argument('--ckpt', type=str,
                        default= f'/kaggle/working/checkpoints',
...
def set_default_settings(opt):
    ...
    if ('resnet' in opt.model and opt.inspect_layer_position >= 1) \
            or ('preact' in opt.model and opt.inspect_layer_position >= 2) \
...
def load_model(opt):
    ...
    if 'resnet' in opt.model:
        ...
        model_classifier = partial_models_adaptive.PreactAdaptivePartialModel(
